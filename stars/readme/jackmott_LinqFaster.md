...
UPDATE: As of .NET 9 this library is mostly unecessary, as .NET9 had made most of these optimizations part of the native LINQ library, but if you find some useful helper functions, enjoy!  
