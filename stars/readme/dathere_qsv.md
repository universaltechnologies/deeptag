...
🐻‍❄️: command powered/accelerated by [![polars 0.53.0:py_1.40.0](https://img.shields.io/badge/polars-0.53.0:py_1.40.0-blue?logo=polars)](https://github.com/pola-rs/polars/releases/tag/py-1.40.0) vectorized query engine.  
