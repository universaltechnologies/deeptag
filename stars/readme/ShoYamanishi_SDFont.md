...
Most notably, the dead reckoning algorithm is used in `bsdf_raster_render()` in `freetype-2.XX.Y/src/sdf/ftbsdf.c` for their bitmap-based distance calculation.
